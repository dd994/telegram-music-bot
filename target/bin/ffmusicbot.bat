...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="ffmusicbot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.gmail.ddzhunenko.Bot %CMD_LINE_ARGS%
